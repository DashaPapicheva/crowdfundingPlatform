      ...
      <v-col>
        <h1 class="projHeader">
          Проекты
            ...
            <v-card
                class="mx-auto wholeCard"
                max-width="800"
            >
            <div class="flexSection">
                <v-card-title class="flexItem">Cнежкометатели для всех</v-card-title>

                <v-card-text class="flexItem">
                <p>Для всех любителей поиграть в снежки — <br><span class="gun">Тройной снежкометатель</span>.</p>
                </v-card-text>
